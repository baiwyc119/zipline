...
def get_local(use_list=False):
    ...
    """
    datafilepath = os.path.join(os.path.dirname(__file__), 'szsh_data.txt')
...
def get_cache_path():
    usr_home = os.path.expanduser('~/Stock/zipline/zipline/utils')
    cache_dir = os.path.join(usr_home, 'calendars')
    if not(os.path.isdir(cache_dir)):
        os.mkdir(cache_dir)
    return os.path.join(cache_dir, 'shsz_data.txt')
